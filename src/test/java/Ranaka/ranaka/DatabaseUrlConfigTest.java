...
class DatabaseUrlConfigTest {
	...
	@Test
	void convertsSpringDatasourceUrlWhenRenderUrlWasCopiedThere() {
		Properties properties = new Properties();

		DatabaseUrlConfig.configureFromEnvironment(Map.of(
				"SPRING_DATASOURCE_URL", "postgresql://ranaka_db_user:secret@dpg-d8goc1rtqb8s73br5590-a:5432/ranaka_db"), properties);
	...
	@Test
	void leavesExplicitJdbcSpringDatasourceUrlUntouched() {
		Properties properties = new Properties();
